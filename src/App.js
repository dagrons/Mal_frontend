...
import {AreaChartOutlined, InboxOutlined, CloudUploadOutlined} from '@ant-design/icons';
...
class App extends React.Component { // wrapper for Dragger to handling polling
	...
	return (
		...
		<Menu.Item key="2"><AreaChartOutlined style={{fontSize: "16px"}}/>数据面板</Menu.Item>
		<Menu.Item key="1"><CloudUploadOutlined style={{fontSize: "16px"}}/>文件上传</Menu.Item>
		<Menu.Item key="3"><a href="/auth/logout">注销</a></Menu.Item>
